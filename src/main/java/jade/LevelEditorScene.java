...
public class LevelEditorScene extends Scene{
    private String vertexSharderSrc = "#version 330 core\n" +
            ...
            "}";
    private  String fragmenetSharderSrc="#version 330 core\n" +
            "\n" +
            "in vec4 fColor;\n" +
            "out vec4 color;\n" +
            "\n" +
    ...
    public void init(){
        ...
        //pass the shader source code to GPU
        glShaderSource(fragmentID,fragmenetSharderSrc);
        ...
        //Generate VA0, VBO, and EBO buffer object and send to GPU
